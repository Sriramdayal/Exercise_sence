...
gry_r = df["gry_x"] ** 2 + df["gry_y"] ** 2 + df["gry_z"] ** 2
df["acc_r"] = np.sqrt(acc_r)
df["gry_r"] = np.sqrt(gry_r)
...
plot_df[plot_df["set"] == plot_df["set"].unique()[0]]["gry_x"].plot()
plot_df[plot_df["set"] == plot_df["set"].unique()[0]]["gry_y"].plot()
plot_df[plot_df["set"] == plot_df["set"].unique()[0]]["gry_z"].plot()
plot_df[plot_df["set"] == plot_df["set"].unique()[0]]["gry_r"].plot()
...
squat_df=squat_df[squat_df["set"] == squat_df["set"].unique()[0]]
